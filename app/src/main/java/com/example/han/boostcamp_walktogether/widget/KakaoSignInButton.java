...
public class KakaoSignInButton extends FrameLayout {
    private Fragment fragment;
    private android.support.v4.app.Fragment supportFragment;

    public KakaoSignInButton(Context context) {
        super(context);
    }

    public KakaoSignInButton(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public KakaoSignInButton(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onAttachedToWindow() {
        ...
        inflate(getContext(), R.layout.kakao_login_button_layout, this);
    ...
    private Dialog createLoginDialog(final Item[] authItems, final ListAdapter adapter) {
        final Dialog dialog = new Dialog(getContext(), com.kakao.usermgmt.R.style.LoginDialog);
